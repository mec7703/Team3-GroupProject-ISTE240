...
<body>
   ...
   <div class="wrapper">
        ...
        that allows a computer to work as we know them to. It is free, 
        fast, and secure. Unlike Windows and Apple computers, most viruses 
        cannot run on Linux. Because it is so cheap (usually free) and 
        secure, it is commonly used on servers and other big systems. It is 
        also the base of many other electronic systems, like phones, video 
        game consoles, and smartwatches.
        <br />
        Linux has hundreds of different versions all based on the Linux 
        kernel. Each version/distribution is similar at its core but may 
        look different and come with different programs already isntalled. 
